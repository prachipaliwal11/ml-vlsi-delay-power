...
TEMPLATE_PATH = "spice/templates/nor2_template.cir"
DECK_DIR = "spice/generated"
OUTPUT_DIR = "spice/outputs"
MANIFEST_PATH = "data/manifest_nor2.csv"
...
for i in range(N_SAMPLES):
    ...
    # NOR2 characterization: the static input MUST be held at logic 0.
    # Holding it at 1 (VDD) breaks the series PMOS pull-up path permanently
    # while its parallel NMOS stays on, pinning the output at 0 regardless
    # of the switching input -- no delay to measure. This is the mirror
    # image of NAND2, where the static input had to be held at 1 instead.
    static_state = 0
    static_level = 0
    ...
    deck_path = os.path.join(DECK_DIR, f"nor2_{i:04d}.cir")
    output_path = os.path.join(OUTPUT_DIR, f"nor2_{i:04d}_output.txt")
